...
// audio.loop=true;
// when page is fully loaded this function will run...
document.ready(()=>{
    //audio will run after 10s 
    setTimeout(() => {
        audio.play()
    }, 10);
    ...
    document.onkeydown = function (e) {
        ...
        if (e.keyCode == 38) { // click on up arrow
